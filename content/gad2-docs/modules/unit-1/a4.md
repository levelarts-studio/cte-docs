...
- **How to Give Useful Feedback**  
  ...
  - Focus on clarity, feasibility, and scope — not art polish.  

- **How to Receive Feedback**  
  - Listen without arguing.  
  - Ask clarifying questions if you don’t understand a comment.  
  - Decide what to revise — not all feedback needs to be applied, but you should reflect on it.  

- **Feedback in the GDD Context**  
  - Review each other’s narrative, core loop, and features list.  
  - Ask: *“Could I build this game slice if I only had this document?”*  
